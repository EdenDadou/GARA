...
class AddMusic extends Component {
    ...
    onClickUploadMusic = () => {
        ...
        ////////////// A COMPLETER AVEC la fontion pour UPLOAD la music //////////////
                    ...
                    <Card className="auth-card">
                        ...
                        <div className="form-side">
                            ...
                            <CardTitle className="mb-4">
                                <IntlMessages id="menu.music.add" />
                            </CardTitle>
                            <Card>
                                <CardBody className="wizard wizard-default">
                                    ...
                                    <AvForm className="av-tooltip">
                                            ...
                                            <Colxx sm={10} className="offset-1">
                                                <AvGroup className="has-float-label tooltip-right-bottom">
                                                    ...
                                                    <AvField name="title"
                                                        ...
                                                        validate={{
                                                            required: { value: true, errorMessage: 'Please enter the song title' },
                                                            minLength: { value: 2, errorMessage: 'The song title must be between 2 and 16 characters' },
                                                            maxLength: { value: 30, errorMessage: 'The song title must be between 2 and 16 characters' }
                                                        }} />
                                                </AvGroup>
                                            </Colxx>
                                            ...
                                            <Colxx sm={10} className="offset-1">
                                                <AvGroup className="has-float-label tooltip-right-bottom">
                                                    ...
                                                    <AvField
                                                        ...
                                                        validate={{
                                                            required: { value: true, errorMessage: 'Please enter a song description' },
                                                            minLength: { value: 10, errorMessage: 'Description must be between 10 and 100 characters' },
                                                            maxLength: { value: 100, errorMessage: 'Description must be between 10 and 100 characters' }
                                                        }} />
                                                </AvGroup>
                                            </Colxx>
                                        ...
                                        <Button className="button-center space-between"
                                            onClick={this.onClickUploadMusic}>Upload Music</Button>
                                    </AvForm>
                                </CardBody>
                            </Card>
                        </div >
