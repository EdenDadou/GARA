                        ...
                        <ReactSiemaCarousel
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <CardBody className="text-center">
                                        <div className="mb-4">
                                            <i className="iconsminds-speach-bubble large-icon"></i>
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <CardBody className="text-center">
                                        <div className="mb-4">
                                            <i className="iconsminds-conference large-icon"></i>
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <CardBody className="text-center">
                                        <div className="mb-4">
                                            <i className="iconsminds-play-music large-icon"></i>
                            ...
                            <div className="pr-3 pl-3">
                                <Card>
                                    <CardBody className="text-center">
                                        <div className="mb-4">
                                            <i className="iconsminds-folder large-icon"></i>
